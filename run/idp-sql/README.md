...
[![Run on Google Cloud](https://deploy.cloud.run/button.svg)](https://deploy.cloud.run/?git_repo=https://github.com/averikitsch/java-docs-samples&revision=cats-v-dogs&dir=run/idp-sql/)
