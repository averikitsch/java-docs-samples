...
public class IdpSqlApplication {
  ...
  public static void main(String[] args) throws IOException {
    ...
    HashMap<String, Object> config = getConfig(projectId, "java-secrets", "latest");
  ...
  /**
   * Retrieve project Id from metadata server
   * Set $GOOGLE_CLOUD_PROJECT env var to run locally
   */
  ...
  public static HashMap<String, Object> getConfig(String projectId, String secretId, String versionId) throws IOException {
